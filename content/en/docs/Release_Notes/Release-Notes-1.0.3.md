...
- [x] The new **StreamZero Executor** has become even better and more powerful. Add any Python, SQL or JSON to execute any type of jobs.
...
- [x] The **StreamZero Application Builder (FAB)** is now capable of auto generating new pages (UI) on the fly.
