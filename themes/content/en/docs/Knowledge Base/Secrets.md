...
{{< blocks/screenshot color="white" image="/streamzero/images/user_guide/check_package_secrets.png">}}
...
{{< blocks/screenshot color="white" image="/streamzero/images/user_guide/check_script_run_execution_secrets.png">}}
...
{{< blocks/screenshot color="white" image="/streamzero/images/user_guide/package_execution_secrets.png">}}

5. Click on List Steps tab to open the package execution steps details page

{{< blocks/screenshot color="white" image="/streamzero/images/user_guide/details_page_package_execution_secrets.png">}}

6. Click on Show Results to open and see the decrypted secrets

{{< blocks/screenshot color="white" image="/streamzero/images/user_guide/package_exec_steps_secrets.png">}}

{{< blocks/screenshot color="white" image="/streamzero/images/user_guide/show_results_decrypted_secrets.png">}}