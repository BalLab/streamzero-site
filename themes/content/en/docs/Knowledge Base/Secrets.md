...
{{< blocks/screenshot color="white" image="/streamzero/images/check_package_secrets.png">}}
...
{{< blocks/screenshot color="white" image="/streamzero/images/check_script_run_execution_secrets.png">}}
...
{{< blocks/screenshot color="white" image="/streamzero/images/package_execution_secrets.png">}}

5. Click on List Steps tab to open the package execution steps details page

{{< blocks/screenshot color="white" image="/streamzero/images/details_page_package_execution_secrets.png">}}

6. Click on Show Results to open and see the decrypted secrets

{{< blocks/screenshot color="white" image="/streamzero/images/package_exec_steps_secrets.png">}}

{{< blocks/screenshot color="white" image="/streamzero/images/show_results_decrypted_secrets.png">}}